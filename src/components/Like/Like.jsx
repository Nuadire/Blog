  ...
  render () {
    ...
    return (
      <label className="like">
        {
          isPublic ? 
          <input type="checkbox" className="like__checkbox-hide" checked={false} readOnly /> :
          <input type="checkbox" className="like__checkbox-hide" checked={favorited} onChange={this.toggleFavorites} /> 
        }
